...
<div class="row justify-content-center text-center mt-4">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/2024-fireplaces/behaviour_change.png" title="Behavioural Change Data" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
**Stellenbosch University Press Release:**
The video below shows an extract of the soundbites recorded for the official university press release, summarising the core findings of the study for public distribution.
